...
bool ScdParser::generateSCD(const SampledValueControl& config, const std::string& outputPath) {
    ...
    ss << "              <!-- FCDA entries for 8 channels (IEC 61850-9-2LE compliant) -->\n";
    ss << "              <!-- 4 Current channels: IA, IB, IC, IN -->\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TCTR\" lnInst=\"1\" doName=\"AmpSv\" daName=\"instMag.i\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TCTR\" lnInst=\"2\" doName=\"AmpSv\" daName=\"instMag.i\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TCTR\" lnInst=\"3\" doName=\"AmpSv\" daName=\"instMag.i\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TCTR\" lnInst=\"4\" doName=\"AmpSv\" daName=\"instMag.i\" fc=\"MX\"/>\n";
    ss << "              <!-- 4 Voltage channels: VA, VB, VC, VN -->\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TVTR\" lnInst=\"1\" doName=\"VolSv\" daName=\"instMag.i\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TVTR\" lnInst=\"2\" doName=\"VolSv\" daName=\"instMag.i\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TVTR\" lnInst=\"3\" doName=\"VolSv\" daName=\"instMag.i\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TVTR\" lnInst=\"4\" doName=\"VolSv\" daName=\"instMag.i\" fc=\"MX\"/>\n";
    ss << "              <!-- Quality for each channel (IEC 61850-9-2LE requires 8 quality values) -->\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TCTR\" lnInst=\"1\" doName=\"AmpSv\" daName=\"q\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TCTR\" lnInst=\"2\" doName=\"AmpSv\" daName=\"q\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TCTR\" lnInst=\"3\" doName=\"AmpSv\" daName=\"q\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TCTR\" lnInst=\"4\" doName=\"AmpSv\" daName=\"q\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TVTR\" lnInst=\"1\" doName=\"VolSv\" daName=\"q\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TVTR\" lnInst=\"2\" doName=\"VolSv\" daName=\"q\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TVTR\" lnInst=\"3\" doName=\"VolSv\" daName=\"q\" fc=\"MX\"/>\n";
    ss << "              <FCDA ldInst=\"LD_SV\" prefix=\"\" lnClass=\"TVTR\" lnInst=\"4\" doName=\"VolSv\" daName=\"q\" fc=\"MX\"/>\n";
    ss << "            </DataSet>\n\n";
